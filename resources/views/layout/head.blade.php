    ...
    <header id="top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-white fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Light<span>Up</span></a>
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{!! asset('theme/img/intro/banner-bg1.png') !!}" alt="Los Angeles" width="1100"
                            height="500">
                        <div class="container">
                    ...
                    <div class="carousel-item">
                        <img src="{!! asset('theme/img/intro/banner-bg2.png') !!}" alt="Chicago" width="1100"
                            height="500">
                        <div class="container">
                            <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="{!! asset('theme/img/intro/banner-bg3.png') !!}" alt="New York" width="1100"
                            height="500">
                        <div class="container">
                            <div class="carousel-caption">
